...
namespace TradeLogic.UnitTests
{
    ...
    public class TradeTests
    {
        ...
        public void Constructor_WithMultipleFills_CreatesTradeSuccessfully()
        {
            ...
            Assert.That(trade.Fills.Count, Is.EqualTo(3));
        }
        ...
        public void Constructor_WithDifferentExitReasons_CreatesTradeSuccessfully()
        {
            ...
            var tpTrade = new Trade(tradeId, positionId, Symbol.ES, Side.Long, openTime, closeTime, ExitReason.TakeProfit, 10, 150m, 155m, 500m, 5m, 0m, fills);
            var slTrade = new Trade(tradeId, positionId, Symbol.ES, Side.Long, openTime, closeTime, ExitReason.StopLoss, 10, 150m, 145m, -500m, 5m, 0m, fills);
            var manualTrade = new Trade(tradeId, positionId, Symbol.ES, Side.Long, openTime, closeTime, ExitReason.ManualGoFlat, 10, 150m, 152m, 200m, 5m, 0m, fills);
            var eosTrade = new Trade(tradeId, positionId, Symbol.ES, Side.Long, openTime, closeTime, ExitReason.EndOfSession, 10, 150m, 151m, 100m, 5m, 0m, fills);
        ...
        public void Constructor_WithDifferentSymbols_CreatesTradeSuccessfully()
        {
            ...
            var esTrade = new Trade(tradeId, positionId, Symbol.ES, Side.Long, openTime, closeTime, ExitReason.TakeProfit, 10, 150m, 155m, 500m, 5m, 0m, fills);
            var nqTrade = new Trade(tradeId, positionId, Symbol.NQ, Side.Long, openTime, closeTime, ExitReason.TakeProfit, 10, 150m, 155m, 500m, 5m, 0m, fills);
        ...
        public void Properties_AreReadOnly()
        {
            ...
            Assert.That(trade.Fills, Is.Not.Null);
        }

        [Test]
        public void Fills_IsReadOnlyList()
        {
            var trade = CreateSampleTrade();

            Assert.That(trade.Fills, Is.InstanceOf<IReadOnlyList<Fill>>());
        }
        ...
        public void Constructor_WithZeroFees_CreatesTradeSuccessfully()
        {
            ...
            var trade = new Trade(tradeId, positionId, Symbol.ES, Side.Long, openTime, closeTime, ExitReason.TakeProfit, 10, 150m, 155m, 500m, 0m, 0m, fills);
